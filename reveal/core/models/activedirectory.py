...
class ADUser(db.Model):
    ...
    BadLogonCount = db.Column(db.Integer, unique=False, nullable=True)
    BadPwdCount = db.Column(db.Integer, unique=False, nullable=True)
    ...
    logonCount = db.Column(db.Integer, unique=False, nullable=True)
