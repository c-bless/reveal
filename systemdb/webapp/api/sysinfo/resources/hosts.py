...
from systemdb.webapp.api.utils import token_required
from systemdb.core.models.sysinfo import Host, Service, Product, User, Group, NetIPAddress, Hotfix, NetAdapter, \
    Printer, ConfigCheck, PSInstalledVersions
from systemdb.webapp.api.sysinfo.schemas.responses.hosts import HostSchema, UserSchema, GroupSchema, HotfixSchema, \
    NetAdapterSchema, PrinterSchema, PSInstalledVersionsSchema, ConfigCheckSchema, NetIPAddressSchema
from systemdb.webapp.api.sysinfo.schemas.responses.service import ServiceSchema
from systemdb.webapp.api.sysinfo.schemas.responses.product import ProductSchema
from systemdb.webapp.api.sysinfo.schemas.responses.usermgmt import UserGroupAssignment
from systemdb.webapp.sysinfo.reports.usermgmt import get_direct_domainuser_assignments
from systemdb.webapp.api.auth_schema import AuthErrorSchema
...
class HostByIdView(MethodView):
    ...
    @blp.response(HTTPStatus.UNAUTHORIZED, AuthErrorSchema)
    def get(self, id):
        print("HostByIdView")
