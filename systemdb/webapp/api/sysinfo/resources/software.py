...
from systemdb.webapp.api.sysinfo.schemas.arguments.products import ProductNameSearchSchema
from systemdb.webapp.api.sysinfo.schemas.arguments.services import ServicePermissionSearchSchema
...
from systemdb.webapp.api.sysinfo.schemas.responses.service import ServiceACLSchema

from systemdb.core.models.eol import EoL
from systemdb.webapp.api.sysinfo.schemas.responses.eol import EoLSchema
...
class ProductByIdView(MethodView):
    ...
    @blp.doc(description="Return an installed product based on specified ID", summary="Find product by ID")
