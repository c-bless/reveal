...
from systemdb.core.regex import RE_AD_TRUSTS_SOURCE
from systemdb.core.regex import RE_AD_TRUSTS_TARGET
from systemdb.core.regex import RE_AD_TRUSTS_DIRECTION
