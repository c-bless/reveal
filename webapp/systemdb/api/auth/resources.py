...
from webapp.systemdb.api.auth.schema import LoginUserSchema
...
class UserLogin(MethodView):
    ...
    @blp.doc(description="Login a user via API.", summary="Login a user")
    @blp.arguments(LoginUserSchema, location='json')
