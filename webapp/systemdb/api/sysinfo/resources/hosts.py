...
from webapp.systemdb.models.sysinfo import Host, Service, Product, User, Group, NetIPAddress, Hotfix, NetAdapter, \
    Printer, ConfigCheck, PSInstalledVersions
from webapp.systemdb.api.sysinfo.schemas.responses.hosts import HostSchema, UserSchema, GroupSchema, HotfixSchema, \
    NetAdapterSchema, PrinterSchema, PSInstalledVersionsSchema, ConfigCheckSchema, NetIPAddressSchema
from webapp.systemdb.api.sysinfo.schemas.responses.service import ServiceSchema
